...
(function () {
	...
	$(document).ready(function () {
		var option = $('.js-tabs-select2 .option');
		...
		option.on('click', function () {
			...
			console.log(indexOption);
			$('.js-tabs-item2').hide();
			$('.js-tabs-item2').eq(indexOption).fadeIn();
		});
	});
})(); 
// tabs 1
(function () {
	...
	$(document).ready(function () {
		var option = $('.js-tabs-select3 .option');
		...
		option.on('click', function () {
			...
			console.log(indexOption);
			$('.js-tabs-item3').hide();
			$('.js-tabs-item3').eq(indexOption).fadeIn();
		});
	});
})();
// favorite for table
...
//  Profile Dropdown
$('.sidebar__user1').on('click', function () {
	$(this).toggleClass('active');
	$('.sidebar__details').toggle();
});
// price toggle menu
